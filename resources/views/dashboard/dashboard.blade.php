								...
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right">
										<a class="dropdown-item" href="#"><i
												class="ion-android-list"></i>{{__('Details')}} </a>
										<a class="dropdown-item" href="#"><i class="ion-android-add"></i> Add new</a>
										<a class="dropdown-item" href="#"><i class="ion-android-refresh"></i>
											Refresh</a>
									</div>
				...
				<div class="row" style="margin-bottom: 8px;">
									...
									<table class="table">
										...
										<tbody>
											...
											<tr>
												...
												<td style="text-align: left;">
													{{$dernier_cloture_item->personnePhysique()->first()->full_name}}
												</td>
												@else
					...
					<div class="col-xl-12 col-lg-12 col-md-12" style="margin-top: 16px">
						<div class="box"
							style="margin-bottom: 0px;background-color: unset !important;-webkit-box-shadow: 0px 5px 20px rgba(0, 0, 0, 0.05); box-shadow: 0px 5px 20px rgba(0, 0, 0, 0.05);border: 1px solid #dce3e6 !important">
							<div class="box-header" style="background: #FFF;height:100%">
								<h5 class="box-title">{{__('Dernièrement en retard')}}</h5>
								<div class="table-responsive">
									<table class="table">
										<thead>
											<th>{{__('Objet')}}</th>
										...
										<tbody>
											...
											<tr>
												<td style="text-align: left;">
													{{ str_limit($dernier_en_retard_item->objet, 50) }}</td>

												@if ($dernier_en_retard_item->personne_physique_id != null )
												<td style="text-align: left;">
													{{$dernier_en_retard_item->personnePhysique()->first()->full_name}}
												</td>
												@else
												@if ($dernier_en_retard_item->personneMorale()->first() != null)
												<td style="text-align: left;">
													{{$dernier_en_retard_item->personneMorale()->first()->raison_social}}
												</td>
												@else
												<td style="text-align: left;"></td>
												@endif
											...
											@else
											<tr>
												<td colspan="3">{{__('Aucun courrier trouvé')}}</td>
											</tr>
