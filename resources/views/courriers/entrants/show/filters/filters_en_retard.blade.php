<div class="filters" style="margin-bottom: 4px;margin-top: 6px">
    <div class="row">
        ...
        <div class="col-lg-2">
            <div class="form-group">
                <select class="form-control select2" style="width: 100%;" name="nature_expediteur_en_retard"
                    id="nature_expediteur_en_retard_select_filter">
        ...
        <div class="col-lg-2">
            <div class="form-group">
                <select class="form-control select2" style="width: 100%;" name="expediteur_en_retard"
                    id="expediteur_en_retard_select_filter">
                    <option value="all" selected>{{__('Indifferent')}}</option>
        ...
        <div class="col-lg-2">
            <div class="form-group">
                <select class="form-control select2" style="width: 100%;" name="services_concernes_en_retard"
                    id="services_concernes_en_retard_select_filter">
                    <option value="all" selected>{{__('Indifferent')}}</option>
    ...
    <div class="row" style="margin-top: 6px">
        ...
        <div class="col-lg-2">
            <div class="form-group">
                <select class="form-control select2" style="width: 100%;" name="mode_reception_en_retard"
                    id="mode_reception_en_retard_select_filter">
                    <option value="all" selected>{{__('Indifferent')}}</option>
        ...
        <div class="col-lg-2">
            <div class="form-group">
                <select class="form-control select2" style="width: 100%;" name="priorite_en_retard"
                    id="priorite_en_retard_select_filter">
                    <option value="all" selected>{{__('Indifferent')}}</option>
