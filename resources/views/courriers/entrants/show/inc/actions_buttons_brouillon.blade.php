<div class="row" >
        <div class="col-lg-6 col-xl-6 col-md-6 col-12">
            <button type="button" class="btn btn-default pull-left multiple-choice-brouillon" id="valider_courrier_entrant_btn" style="margin-right : 6px" disabled><i class="fa fa-thumbs-up" style="margin-right: 6px"></i>Valider </button>
        ...
        <div class="col-lg-6 col-xl-6 col-md-6 col-12">            
            ...
            {{Form::close()}}
            <a href="{{ route('documents-entrants-create') }}" class="btn btn-default pull-right " style="margin-right:4px"><i class="fa fa-plus" style="margin-right: 6px"></i>Ajouter
                une entrée</a>
        </div>      
</div>
