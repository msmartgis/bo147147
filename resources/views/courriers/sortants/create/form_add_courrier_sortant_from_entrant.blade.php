                     ...
                     <div class="row">  
                         ...
                         <div class="col-lg-6">
                             ...
                             @if ($courrier_entrant->personnePhysique != null )
                                <div class="form-group">  
                                    <input type="hidden" name="personne_physique_from_entrant_id" value="{{$courrier_entrant->personnePhysique()->first()->id}}">
                             ...
                             @else
                                <div class="form-group">  
                                    <input type="hidden" name="personne_morale_from_entrant_id" value="{{$courrier_entrant->personneMorale()->first()->id}}">
