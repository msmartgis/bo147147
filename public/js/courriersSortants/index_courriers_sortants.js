$(document).ready(function () {
    ...
    $('#add_piece_btn').on('click', function () {
        ...
        $('.table-piece tr:last').after(
            ...
            '<td> ' +
            '<div class = "form-group"> ' +
            '<select name="modes_envoi[]" class="form-control">' + markup_select_option +
            '</select>' +
            '</div>' +
            '</td>' +
            ...
            '<td> ' +
            '<div class = "form-group"> ' +
            '<input type="text" class="form-control datepicker-documents-table" value="' + actueDate + '"   name="date_envoi_doc_input[]"> ' +
            '</div>' +
            '</td>' +
    ...
    $('#add_accuse_reception_btn').on('click', function () {
        if (item_number_accuse_receptions < 3) {
            $('.table-accuse-reception tr:last').after(
                ...
                '<td> ' +
                '<div class = "form-group"> ' +
                '<input type="text" class="form-control datepicker-table" value="' + actueDate + '"   name="date_accuse_envoi[]"> ' +
                '</div>' +
                '</td>' +
