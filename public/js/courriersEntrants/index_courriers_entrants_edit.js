$(document).ready(function () {
    ...
    $('#add_piece_btn').on('click', function () {
        ...
        $('.table-piece tr:last').after(
            ...
            '<td> ' +
            '<div class = "form-group"> ' +
            '<select name="modes_receptions_documents_fournis[]" class="form-control">' + markup_select_option +
            '</select>' +
            '</div>' +
            '</td>' +
            ...
            '<td> ' +
            '<div class = "form-group"> ' +
            '<input type="text" class="form-control datepicker-documents-table" value="' + actueDate + '"   name="date_reception_documents_fournis[]"> ' +
            '</div>' +
            '</td>' +
    ...
    $('#add_remarque_consigne_id_btn').on('click', function () {
        ...
        $('.remarque-consigne-table tr:last').after(
            ...
            '<td>' + consigne_number + '</td>' +

            '<td> <input type="hidden" name="consignes_added_message[]" value="' + message + '"/>' + message + '</td>' +
