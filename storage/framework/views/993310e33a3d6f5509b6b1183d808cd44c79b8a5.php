		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="box bg-info"
						...
						<div class="flexbox">
							...
							<div class="dropdown">
								<span class="dropdown-toggle no-caret" data-toggle="dropdown"><i
										class="ion-android-more-vertical rotate-90"></i></span>
								<div class="dropdown-menu dropdown-menu-right">
									<a class="dropdown-item" href="#"><i class="ion-android-list"></i><?php echo e(__('Details')); ?>
					...
					<div class="card-body bg-gray-light py-12">
						<a href="<?php echo e(route('documents-entrants')); ?>" class="small-box-footer"
			...
			<div class="row">
				...
				<div class="box bg-warning"
					...
					<div class="card-body bg-gray-light py-12">
						<a href="<?php echo e(route('documents-sortants')); ?>" class="small-box-footer"
							style="z-index: 0;font-weight: 100;"><b><?php echo e(__('Voir les details')); ?> </b> <i
								class="fa fa-arrow-right"></i></a>
					</div>
				</div>
		...
		<div class="col-xl-9 col-lg-9 col-md-9 col-12">
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										...
										<tr>
											<td style="text-align: left;"><?php echo e($dernier_recu_item->ref); ?></td>
						...
						<div class="table-responsive">
							<table class="table">
								...
								<tbody>
									...
									<tr>
										<td style="text-align: left;"><?php echo e($dernier_cloture_item->ref); ?></td>
										<td style="text-align: left;">
											<?php echo e(str_limit($dernier_cloture_item->objet, 50)); ?></td>

										<?php if($dernier_cloture_item->personne_physique_id != null ): ?>
										<td style="text-align: left;">
											<?php echo e($dernier_cloture_item->personnePhysique()->first()->full_name); ?></td>
										<?php else: ?>
										...
										<td style="text-align: left;"><?php echo e($dernier_cloture_item->delai); ?></td>
										<td style="text-align: left;"><?php echo e($dernier_cloture_item->etat->etat_nom); ?>
			...
			<div class="col-xl-12 col-lg-12 col-md-12" style="margin-top: 16px">
				<div class="box"
					style="margin-bottom: 0px;background-color: unset !important;-webkit-box-shadow: 0px 5px 20px rgba(0, 0, 0, 0.05); box-shadow: 0px 5px 20px rgba(0, 0, 0, 0.05);border: 1px solid #dce3e6 !important">
					<div class="box-header" style="background: #FFF;height:100%">
						<h5 class="box-title"><?php echo e(__('Dernièrement sorties')); ?></h5>
						<div class="table-responsive">
							<table class="table">
								<thead>
									<th><?php echo e(__('Ref')); ?></th>
								...
								<tbody>
									<?php $__currentLoopData = $dernierement_envoye; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dernier_envoye_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										<td style="text-align: left;"><?php echo e($dernier_envoye_item->ref); ?></td>
										<td style="text-align: left;">
											<?php echo e(str_limit($dernier_envoye_item->objet, 50)); ?></td>

										<?php if($dernier_envoye_item->personne_physique_id != null ): ?>
										<td style="text-align: left;">
											<?php echo e($dernier_envoye_item->personnePhysique()->first()->full_name); ?></td>
										<?php else: ?>
										<?php if($dernier_envoye_item->personneMorale()->first() != null): ?>
										<td style="text-align: left;">
											<?php echo e($dernier_envoye_item->personneMorale()->first()->raison_social); ?>
										...
										<td style="text-align: left;"><?php echo e($dernier_envoye_item->delai); ?></td>
										<td style="text-align: left;"><?php echo e($dernier_envoye_item->etat->etat_nom); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\smartgis\bureau_ordre\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>