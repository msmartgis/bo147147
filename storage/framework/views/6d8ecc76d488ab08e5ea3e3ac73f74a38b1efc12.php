...
<?php $__env->startPush('added_scripts'); ?>
    ...
    <script src="<?php echo e(asset('js/diffusion_interne/index_diffusion_interne.js')); ?>"></script>
    <script src="<?php echo e(asset('js/services/index_services.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\smartgis\bureau_ordre\resources\views/diffusion_interne/create/index_create_di.blade.php ENDPATH**/ ?>