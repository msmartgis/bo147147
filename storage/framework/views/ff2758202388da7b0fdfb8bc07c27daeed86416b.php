                    ...
                    <div class="box-body">
                        <div class="tab-content">
                                        ...
                                        <div class="table-responsive" style="margin-top: 12px">
                                            <table class="table table-service-assigne">
                                                ...
                                                <tbody id="service_assigne_tbody">
                                                    <?php $__currentLoopData = $diffusionInterne->services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                ...
                                                <tbody id="piece_diffusionInterne_tbody">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">
                                                            ...
                                                            <button type="button"
                                                                class="btn delete-row btn-danger-table m-hidden">
                                                                <i class="fa fa-close"></i> <?php echo e(__('Supprimer')); ?>
                            ...
                            <div class="tab-pane" id="observations_tab" role="tabpanel">
                                <div class="pad">
                                    <h5 class="<?php echo e(__('costum_css.float-right-m')); ?>"><?php echo e(__('OBSERVATIONS ET REMARQUES')); ?>
            ...
            <div class="box bg-transparent no-border no-shadow ">
                <div class="box-body no-padding mailbox-nav ">
                    ...
                    <button type="button" class="btn delete-row btn-danger-table" style="color : #f99830"> <i
                        ...
                        <b><?php echo e(__('Fiche de diffusion interne')); ?></b> </button>
...
<!-- /.row --><?php /**PATH E:\xampp\htdocs\smartgis\bureau_ordre\resources\views/diffusion_interne/edit/form_edit.blade.php ENDPATH**/ ?>