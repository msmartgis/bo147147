        ...
        <div class="h-p100  bg-light bg-secondary-gradient" style="padding-right: 5px;height: 100%;">
            <div class="box bg-transparent no-border no-shadow ">
                <div class="box-body no-padding mailbox-nav ">
                    ...
                    <br>
                    <button type="button" class="btn delete-row btn-danger-table <?php echo e(__('costum_css.float-right-btn-m')); ?>"
                        style="color : #f99830"> <i class="fa fa-file" style="margin-right : 4px"></i>
                        <b><?php echo e(__('Fiche de courrier')); ?></b> </button>
                    ...
                    <?php if(Auth::user()->role->first()->role_name == "bureau_ordre" ||
                    Auth::user()->role->first()->role_name == "admin"): ?>
                    <?php if($courrier->etat_id == "de4d5fe6-a384-4df0-abeb-6f953f4102f4"): ?>
...
<!-- /.row --><?php /**PATH C:\xampp\htdocs\bureau_ordre\resources\views/courriers/sortants/edit/form_edit_courrier_sortant.blade.php ENDPATH**/ ?>