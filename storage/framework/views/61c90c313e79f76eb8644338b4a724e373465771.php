<div class="filters" style="margin-bottom: 4px;margin-top: 6px">
    ...
    <div class="row" style="margin-top: 6px">
        ...
        <div class="col-lg-2">
            <div class="form-group">
                <select class="form-control select2 tous-select" style="width: 100%;" name="priorite_tous">
                    <option value="all" selected><?php echo e(__('Indifferent')); ?></option>
    ...
    <hr style="margin:4px">
</div><?php /**PATH C:\xampp\htdocs\bureau_ordre\resources\views/courriers/entrants/show/filters/filters_tous.blade.php ENDPATH**/ ?>