<div class="row">
    ...
    <div class="col-lg-6 col-xl-6 col-md-6 col-12">
        ...
        <button type="button" class="btn btn-default <?php echo e(__('costum_css.pull-right')); ?> multiple-choice-en-retard"
...
<hr style="margin:4px"><?php /**PATH C:\xampp\htdocs\bureau_ordre\resources\views/courriers/entrants/show/inc/actions_buttons_en_retard.blade.php ENDPATH**/ ?>