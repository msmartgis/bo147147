    ...
    <div class="modal-dialog ">
        <div class="modal-content" style="border-radius: 6px;">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="modalTitleAccordAndAffect"><?php echo e(__('Assigne à un service/ou division')); ?></h4>
...
</div><?php /**PATH E:\xampp\htdocs\smartgis\bureau_ordre\resources\views/diffusion_interne/create/modals.blade.php ENDPATH**/ ?>