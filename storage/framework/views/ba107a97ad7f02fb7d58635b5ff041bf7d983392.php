<div class="filters" style="margin-bottom: 4px;margin-top: 6px">
            ...
            <div class="form-group <?php echo e(__('costum_css.date-style-m')); ?>">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control pull-left brouillon-select date-range-input"
                        name="date_envoie_brouillon_daterange" value="01/01/<?php echo e(now()->year); ?> - 30/12/<?php echo e(now()->year); ?>"
    ...
    <hr style="margin:4px">
</div><?php /**PATH E:\xampp\htdocs\smartgis\bureau_ordre\resources\views/courriers/sortants/show_sortant/filters_sortant/filters_brouillon_sortant.blade.php ENDPATH**/ ?>