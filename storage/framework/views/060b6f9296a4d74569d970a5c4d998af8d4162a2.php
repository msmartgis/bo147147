            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-xl-6 col-md-6 col-12">
                        ...
                        <button type="button"
                            class="btn btn-danger  <?php echo e(__('costum_css.pull-right')); ?>   multiple-choice-brouillon"
                            id="supprimer_diffusion_interne_btn" style="margin-right : 6px" disabled><i
                                class="fa fa-trash" style="margin-right: 6px;margin-left: 6px"></i><?php echo e(__('Supprimer')); ?>
                        ...
                        <a href="<?php echo e(route('diffusions-internes-create')); ?>"
                            class="btn btn-default <?php echo e(__('costum_css.pull-right')); ?> " style="margin-right:4px"><i
                                class="fa fa-plus"
                                style="margin-right: 6px;margin-left: 6px"></i><?php echo e(__('Nouvelle diffusion')); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
...
<script src="<?php echo e(asset('js/diffusion_interne/show/index_show.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\smartgis\bureau_ordre\resources\views/diffusion_interne/show/index_diffusion_interne.blade.php ENDPATH**/ ?>