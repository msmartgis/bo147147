        ...
        <section>
            <div class="row">      
                <div class="row col-12">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                                <?php echo e(Form::label('','Nature de diffusion :')); ?>
                    ...
                    <div class="col-lg-4"> 
                            <div class="form-group">
                            <?php echo e(Form::label('','Date d\'envoi:')); ?>
...
<?php /**PATH C:\xampp\htdocs\bureau_ordre\resources\views/diffusion_interne/create/form_add_diffusion_interne.blade.php ENDPATH**/ ?>