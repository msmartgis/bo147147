<div class="filters" style="margin-bottom: 4px;margin-top: 6px">
            ...
            <div class="form-group <?php echo e(__('costum_css.date-style-m')); ?>">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control pull-left " name="date_reception_brouillon_daterange"
                        value="01/01/<?php echo e(now()->year); ?> - 30/12/<?php echo e(now()->year); ?>" id="date_reception_brouillon_input"
    ...
    <hr style="margin:4px">
</div><?php /**PATH C:\xampp\htdocs\bureau_ordre\resources\views/courriers/entrants/show/filters/filters_brouillon.blade.php ENDPATH**/ ?>