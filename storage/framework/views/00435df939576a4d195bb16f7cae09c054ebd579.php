				  ...
				  <div class="login-box-body" style="text-align: center">
					...
					<form method="POST" action="<?php echo e(route('login')); ?>">
					  ...
					  <div class="form-group has-feedback">                       
                        <input id="username" type="text" class="form-control<?php echo e($errors->has('username') ? ' is-invalid' : ''); ?> rounded" name="username" value="<?php echo e(old('username')); ?>" placeholder="Identifiant" required autofocus>
					  ...
					  <div class="form-group has-feedback">                        
                        <input id="password" type="password" class="form-control<?php echo e($errors->has('password') ? ' is-invalid' : ''); ?> rounded" placeholder="Mot de passe" name="password" required>
...
<?php /**PATH C:\xampp\htdocs\bureau_ordre\resources\views/auth/login.blade.php ENDPATH**/ ?>