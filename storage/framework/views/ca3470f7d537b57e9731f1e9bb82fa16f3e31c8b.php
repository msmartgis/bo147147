    ...
    <div class="modal-dialog ">
        <div class="modal-content" style="border-radius: 6px;">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="modalTitleAccordAndAffect"><?php echo e(__('Service Emetteur')); ?></h4>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                            <div class="form-group">
                                <?php echo e(Form::label('',trans('Services/Division').' :')); ?>
...
</div><?php /**PATH E:\xampp\htdocs\smartgis\bureau_ordre\resources\views/courriers/sortants/create/modals.blade.php ENDPATH**/ ?>