<ul class="nav nav-tabs " role="tablist" style="margin-top:16px;">
        ...
        <?php endif; ?>
        <li class="nav-item"> <a class="nav-link <?php if(Auth::user()->role->first()->role_name == 'president'): ?> active
                        <?php endif; ?>" data-toggle="tab" href="#en_cours_tab" role="tab" style="font-size: 13px;"><span
                                class="hidden-sm-up"><i><img src="<?php echo e(asset('images/svg/thumbs-up-.svg')); ?>"
                                                style="width: 20px;"></i></span> <span
                                class="hidden-xs-down m-font-bold">
                                <b><?php echo e(__('EN COURS')); ?></b></span></a> </li>
        ...
        <li class="nav-item"> <a class="nav-link " data-toggle="tab" href="#tous_tab" role="tab"
                        style="font-size: 13px;"><span class="hidden-sm-up"><i><img
                                                ...
                                                style="width: 20px;"></i></span> <span
                                class="hidden-xs-down m-font-bold"> <b><?php echo e(__('TOUS')); ?></b>
                        </span></a> </li>
</ul><?php /**PATH E:\xampp\htdocs\smartgis\bureau_ordre\resources\views/courriers/sortants/show_sortant/tabs_sortant.blade.php ENDPATH**/ ?>