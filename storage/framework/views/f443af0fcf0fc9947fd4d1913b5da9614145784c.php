<div class="filters" style="margin-bottom: 4px;margin-top: 6px">
        ...
        <div class="col-lg-2">
            <div class="form-group <?php echo e(__('costum_css.date-style-m')); ?>">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control pull-left en-cours-select date-range-input" name="date_reception_en_cours_daterange"
    ...
    <hr style="margin:4px">
</div><?php /**PATH E:\xampp\htdocs\smartgis\bureau_ordre\resources\views/courriers/entrants/show/filters/filters_en_cours.blade.php ENDPATH**/ ?>