<div class="tab-pane <?php if(Auth::user()->role->first()->role_name == 'president'): ?> active <?php endif; ?>" id="en_cours_tab"
    role="tabpanel">
    <div class="pad">
...
</div><?php /**PATH E:\xampp\htdocs\smartgis\bureau_ordre\resources\views/courriers/sortants/show_sortant/tabs_sortant/tab_en_cours_sortant.blade.php ENDPATH**/ ?>