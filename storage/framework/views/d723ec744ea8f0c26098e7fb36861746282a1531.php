        ...
        <div class="h-p100  bg-light bg-secondary-gradient" style="padding-right: 5px;height: 100%;">
            <div class="box bg-transparent no-border no-shadow ">
                <div class="box-body no-padding mailbox-nav ">
                    ...
                    <div class="row row-edit">
                        <div class="col-lg-4">
                            <?php echo e(Form::label('',trans('Date courrier') .' : ',['style'=> 'font-size : 11px'])); ?>
                        ...
                        <div class="col-lg-8">
                            <div class="form-group form-group-edit">
                                <div class="input-group date <?php echo e(__('costum_css.date-style-m')); ?>">
                                    ...
                                    <?php echo e(Form::text('date_courrier',$courrier->date_courrier,['class'=>'form-control
                                    pull-right datepicker','disabled'])); ?>
...
<!-- /.row --><?php /**PATH E:\xampp\htdocs\smartgis\bureau_ordre\resources\views/courriers/entrants/edit/form_edit_courrier_entrant.blade.php ENDPATH**/ ?>